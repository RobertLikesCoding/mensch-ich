<template>
  <section class="flex justify-center px-3 gap-5 relative">
    ...
    <!-- decorative shapes -->
    <div class="bg-linear-to-br from-[#5D7E65]/90 via-[#5D7E65] to-[#3A543F]/95 absolute -z-10 md:-top-10 -top-20 -left-10 drop-shadow-xl h-250 sm:h-152 -rotate-3 w-500 max-w-none">
    </div>
  </section>
</template>
